        ...
        {loading ? (
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-blue-100 bg-blue-50 p-4 text-sm text-blue-800 shadow-sm">
              <span className="font-semibold">Note:</span> If the interview didn't take place or is not marked as completed after the date passes (e.g., recruiter no-show), you have the right to send a support ticket regarding the posted job to reach our support team. More details can be found on the Support Tickets page.
            </div>
