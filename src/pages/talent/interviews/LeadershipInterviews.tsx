...
const leadershipInterviewsSeed: Interview[] = [
  {
    id: 1,
    company: "Paystack",
    companyLogo: "PS",
    jobTitle: "Customer Success Team Lead",
    interviewerName: "Sofia Rahman",
    interviewerRole: "Leadership Interviewer",
    date: "26/11/2025",
    time: "04:00 PM",
    duration: "45 mins",
    type: "video",
    meetingLink: "https://meet.google.com/leadership-demo-room",
    status: "upcoming",
    notes: "Leadership round focused on decision-making style, stakeholder communication, and team coaching approach.",
  },
  {
    id: 2,
    company: "Flutterwave",
    ...
    interviewerName: "David Mensah",
    interviewerRole: "VP, Operations",
    date: "12/11/2025",
    time: "02:15 PM",
    duration: "60 mins",
    type: "video",
    meetingLink: "https://zoom.us/j/leadership-review",
    status: "completed",
    notes: "Session covered cross-functional leadership, change management, and performance accountability in distributed teams.",
  },
];
...
const getInterviewSummary = (interview: Interview) => {
  ...
  if (interview.status === "upcoming") {
    return `Prepare for your ${interview.type} interview with ${interview.company} and align your leadership examples with measurable outcomes.`;
  }

  if (interview.status === "completed") {
    return "This interview is complete. Refine your leadership story and be ready for final-stage follow-up.";
  }

  return "This interview was cancelled. Keep monitoring your pipeline for any rescheduled leadership rounds.";
};
...
export default function LeadershipInterviews() {
  ...
  const [interviews] = useState<Interview[]>(leadershipInterviewsSeed);
        ...
        <section className="mb-8 overflow-hidden rounded-[2rem] border border-orange-100 bg-[radial-gradient(circle_at_top_left,_rgba(251,146,60,0.18),_transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(253,186,116,0.14),_transparent_32%),linear-gradient(135deg,_#fff7ed_0%,_#ffffff_58%,_#fff1e6_100%)] p-6 shadow-xl sm:p-8">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-base font-medium leading-7 text-slate-600 sm:text-lg">
              Track your leadership interview pipeline, review completed conversations, and keep follow-up actions in one consistent dashboard view.
            </p>
        ...
        {filteredInterviews.length > 0 ? (
          ...
          <div className="rounded-[2rem] border border-dashed border-orange-200 bg-orange-50/50 px-6 py-16 text-center shadow-sm">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-base leading-7 text-slate-600">
              Your leadership interviews will appear here as soon as they are scheduled or completed.
            </p>
          </div>
        )}
      </div>
