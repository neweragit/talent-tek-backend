...
import { Bell, BellRing, Building2, CalendarDays, DollarSign, Search, ShieldCheck, Users } from "lucide-react";

type NotificationCategory = "billing" | "companies" | "security" | "users" | "system";
...
const notificationsSeed: NotificationItem[] = [
  {
    id: 1,
    title: "Enterprise renewal processed",
    message: "BlueGrid Technologies renewed its annual enterprise subscription successfully.",
    category: "billing",
    status: "unread",
  ...
  {
    id: 2,
    title: "Company admin flagged for compliance review",
    message: "One company admin account was moved into manual verification after unusual login activity.",
    category: "security",
    status: "unread",
  ...
  },
  {
    ...
    message: "Nexa Logistics completed onboarding and activated 12 seats on the Growth plan.",
    category: "companies",
    status: "read",
    createdAt: "2026-03-13T16:25:00",
  },
  {
    id: 4,
    title: "Talent verification surge",
    message: "84 new talents were verified in the last 24 hours, lifting the available supply pool.",
    category: "users",
    status: "read",
  ...
  {
    id: 5,
    title: "Owner analytics snapshot updated",
    message: "The overnight data pipeline completed and owner statistics were refreshed successfully.",
    category: "system",
    status: "unread",
    createdAt: "2026-03-12T22:15:00",
  },
  {
    id: 6,
    title: "Billing retry recovered",
    message: "SlickPay retried 6 failed invoices and recovered 4 of them automatically.",
    category: "billing",
    status: "read",
  ...
  return (
    <OwnerLayout>
      <div className="relative z-10 mx-auto max-w-7xl px-3 py-12 sm:px-4 sm:py-20">
        <section className="mb-8 overflow-hidden rounded-[2rem] border border-orange-100 bg-[radial-gradient(circle_at_top_left,_rgba(251,146,60,0.18),_transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(253,186,116,0.14),_transparent_32%),linear-gradient(135deg,_#fff7ed_0%,_#ffffff_58%,_#fff1e6_100%)] p-6 shadow-xl sm:p-8">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-base font-medium leading-7 text-slate-600 sm:text-lg">
              Track billing movements, company events, security signals, and owner-level platform updates in one timeline.
            </p>
        ...
        <div className="mb-8 grid gap-4 lg:grid-cols-[minmax(0,1fr)_220px] lg:items-stretch">
          ...
          <div className="rounded-3xl border border-orange-100 bg-white p-4 shadow-lg">
            <Select value={statusFilter} onValueChange={(value) => setStatusFilter(value as NotificationStatus)}>
              <SelectTrigger className="h-12 w-full rounded-xl border-orange-200 px-4 text-sm font-semibold text-slate-700 focus:border-orange-400 focus:ring-orange-400">
