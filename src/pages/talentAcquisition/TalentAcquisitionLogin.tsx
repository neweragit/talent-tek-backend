...
const TalentAcquisitionLogin = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        // Check if user is actually a talent acquisition interviewer
        const userRole = localStorage.getItem('userRole');
        const interviewerType = localStorage.getItem('interviewerType');
        
        if (userRole === 'interviewer' && interviewerType === 'talent-acquisition') {
          toast({
            title: "Welcome back!",
            description: "Successfully logged into Talent Acquisition portal",
          });
          navigate("/talent-acquisition/overview");
        } else {
          setError("Access denied. This portal is for Talent Acquisition interviewers only.");
            ...
            <div className="flex flex-col justify-center items-start p-12 bg-gradient-to-br from-[#f93712]/10 to-[#f93712]/5 rounded-l-3xl">
              <div className="mb-8">
                <img 
                  ...
                  alt="Talent acquisition interview"
              ...
              <ul className="space-y-8 text-lg text-black dark:text-slate-300">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-xl mb-2">Conduct Talent Interviews</h4>
                    <p className="text-base dark:text-slate-400">
                      Lead talent acquisition interviews to assess candidate fit, cultural alignment, and soft skills evaluation.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-xl mb-2">Candidate Screening</h4>
                    <p className="text-base dark:text-slate-400">
                      Review candidate profiles, resumes, and initial screening to identify top talent for your organization.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-xl mb-2">Interview Feedback</h4>
                    <p className="text-base dark:text-slate-400">
                      Provide detailed feedback and evaluations to help employers make informed hiring decisions.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-xl mb-2">Talent Assessment</h4>
                    <p className="text-base dark:text-slate-400">
                      Evaluate candidates' motivation, career goals, and alignment with company culture and values.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-xl mb-2">Detailed Reports</h4>
                    <p className="text-base dark:text-slate-400">
                      Generate comprehensive interview reports and recommendations for the hiring decision process.
                    </p>
                  </div>
                </li>
              </ul>
...
export default TalentAcquisitionLogin;